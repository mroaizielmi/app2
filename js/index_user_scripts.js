...
//     END
    ...
    $(document).on("click", ".uib_w_65", function(evt)
    {
        ...
        /* button  Group Cordova */
    $(document).on("click", ".uib_w_60", function(evt)
    {
         /*global activate_page */
         activate_page("#groupchat"); 
         return false;
    });
    ...
    {
     alert("segala mesaj atau gambar yang anda masukkan akan terupload ke group cordova"); 
        /* your code goes here */ 
         return false;
    });
